...
// Provider implements provider.Provider for the NVIDIA hosted NIM catalog.
...
// DiscoverModels fetches /v1/models and normalizes into ProviderModels.
...
// stripping the org prefix and free-tier/variant suffixes
